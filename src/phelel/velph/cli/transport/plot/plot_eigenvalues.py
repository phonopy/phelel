...
def plot_eigenvalues(f_h5py: h5py.File, temperature: float, cutoff_occupancy: float):
    ...
    cutoff_occupancy : float, optional
    ...
    """
    efermi = f_h5py["results/electron_phonon/electrons/dos/efermi"][()]
    dir_eigenvalues = "results/electron_phonon/electrons/eigenvalues"
    eigenvals = f_h5py[f"{dir_eigenvalues}/eigenvalues"][:] - efermi
    ...
    weights = fermi_dirac_distribution(eigenvals, 300)
